...
public interface LogisticsMapper {
    ...
    @Insert("insert into logistics_companies (goods_companies, contacter_id, contacter, contacter_phonne_number, contacter_address) values (#{goods_companies}, #{contacter_id}, #{contacter}, #{contacter_phonne_number}, #{contacter_address})")
